...
def handle_info(message):
    ...
    send_keyboard(message, 'Я помогу тебе получить данные по стоимости акций с московской биржи и отобразить в виде графика', None)
